...
public class VentanaSeleccionComputadora extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        lblSeleccion.setFont(new java.awt.Font("MS UI Gothic", 1, 24)); // NOI18N
        lblSeleccion.setForeground(new java.awt.Color(255, 255, 255));
        lblSeleccion.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lblSeleccion.setText("SELECCION DE COMPUTADORA");
        add(lblSeleccion, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 150, 910, 40));
