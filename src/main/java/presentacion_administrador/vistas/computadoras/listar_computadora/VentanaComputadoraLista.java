package presentacion_administrador.vistas.computadoras.listar_computadora;

import java.util.ArrayList;
import java.util.List;
import javax.swing.JFrame;
import presentacion_administrador.componentes.PanelNavegacion;
import presentacion_administrador.componentes.registros.RegistroComputadoras;

/**
 *
 * @author erwbyel
 */
public class VentanaComputadoraLista extends javax.swing.JPanel {

    private JFrame frame;
    private int paginaActual = 0;
    private int elementosPorPagina = 8;
    private List<RegistroComputadoras> lista;
     ...
     * @param frame
     */
    public VentanaComputadoraLista(JFrame frame) {
        this.frame = frame;
        initComponents();
    ...
    private void initComponents() {
        ...
        lblTituloOperacion.setText("listado de computadoras");
    ...
    private List<RegistroComputadoras> getget() {
        List<RegistroComputadoras> listaNueva = new ArrayList<>();
        for (int i = 0; i < 10; i++) {
            RegistroComputadoras computadoras = new RegistroComputadoras(String.valueOf(i), "MINECRAFT", "1.20.1");
            listaNueva.add(computadoras);
        }
        return listaNueva;
    }
