 ...
 * @author erwbyel
 */
public class VentanaComputadoraQuita extends javax.swing.JPanel {
     ...
     * @param frame
     */
    public VentanaComputadoraQuita(JFrame frame) {
        this.frame = frame;
        initComponents();
    ...
    private void initComponents() {
        ...
        lblTituloOperacion.setText("eliminar computadora");
    ...
    private void botonContinuarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_botonContinuarMouseClicked
        mostrarVentanaComputadoraQuitaConfirmacion(frame);
    }//GEN-LAST:event_botonContinuarMouseClicked

    /**
     * ventana que permite continuar el proceso de quitar una computadora
     *
     * @param frame
     */
    public static void mostrarVentanaComputadoraQuitaConfirmacion(JFrame frame) {
        SwingUtilities.invokeLater(() -> {
            VentanaComputadoraQuitaConfirmar ventana = new VentanaComputadoraQuitaConfirmar(frame);
