 ...
 * @author erwbyel
 */
public class VentanaComputadoraAgregarConfirmar extends javax.swing.JPanel {
     ...
     * @param frame
     */
    public VentanaComputadoraAgregarConfirmar(JFrame frame) {
        this.frame = frame;
        initComponents();
    ...
    private void initComponents() {
        ...
        add(pnlBarraProceso, new org.netbeans.lib.awtextra.AbsoluteConstraints(1050, 180, 330, 70));
        ...
        pnlTituloOperacionLayout.setVerticalGroup(
            pnlTituloOperacionLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(lblTituloOperacion, javax.swing.GroupLayout.DEFAULT_SIZE, 50, Short.MAX_VALUE)
        );

        add(pnlTituloOperacion, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 200, 620, 50));
    ...
    private void lblCancelarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblCancelarMouseClicked
        presentacion_administrador.vistas.computadoras.agregar_computadora.VentanaComputadoraAgrega.mostrarVentanaComputadoraAgregaProgramas(frame);
